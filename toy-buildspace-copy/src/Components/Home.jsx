    ...
    return(
        <div className="container">
            ...
            <div className="about" id="about">
                ...
                <p>Hi! My name is Rudra and I'm a builder at Nights and Weekends Season 5 at Buildspace! You can check out more about me by clicking the links below: <br /><br />
